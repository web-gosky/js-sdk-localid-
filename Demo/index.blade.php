...
<html>
    <head>
        ...
        <script src="http://img.vitabee.cn/web/open/static/js/act/index.js?v=1465915368"></script>
        <style>
            html{
    ...
    <body>
        ...
        <div class="act-show"> 
            <!-- <div class="act-show-part">
             ...
             <div class="act-show">
                <div class="act-show-part">
                    ...
                    <div class="act-show-part-title"><img src="http://img.vitabee.cn/web/open/static/img/act/index/p4-title.jpg" width="100%" alt=""></div>
                    <a href="/vitabee/read/help3">
                        <div class="act-rule-info">
                            <img src="http://img.vitabee.cn/web/open/static/img/act/index/rule.png" alt="">
                        </div>
                    </a>
            ...
            <div class="act-show">
                <div class="act-show-part">
                    <div class="act-show-part-title">
                    	<img src="http://img.vitabee.cn/web/open/static/img/act/index/p1-title.jpg" width="100%" alt="">
            ...
            <div class="act-join-btn" id="joinNowBtn">
                <a href="/vitabee/read/plandetails" id="more_url">
                    <div class="act-join-btn-img act-join-btn-box"></div>
                </a>
            </div>
        </div>
